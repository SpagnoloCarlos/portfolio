              ...
              <div>
                ...
                <div className="text">
                  ...
                  <p>
                    ...
                    technology and always looking for new tools and techniques
                    to improve my work and offer innovative solutions to my
                    clients.
                  </p>{" "}
                  <p>
                  ...
                  <p>
                    ...
                    web developer, do not hesitate to contact me. I am sure we
                    can work together to take your projects to the next level.
                  </p>
                </div>
                <span className={`${comic.className}`}>{"</>"}</span>
              </div>
